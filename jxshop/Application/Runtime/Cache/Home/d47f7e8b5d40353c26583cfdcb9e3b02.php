			...
			<div class="filter mt10">
				...
				<div class="filter_wrap">
                    ...
                    <?php if(is_array($data["attrwhere"])): $i = 0; $__LIST__ = $data["attrwhere"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl class="last">
                        ...
                        <?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><dd <?php if(in_array(($v["attr_values"]), is_array($_GET['attr'])?$_GET['attr']:explode(',',$_GET['attr']))): ?>class="cur"<?php endif; ?>>
                            <a href="<?php echo myU('attr',$v['attr_values']);?>"><?php echo ($v["attr_values"]); ?></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
