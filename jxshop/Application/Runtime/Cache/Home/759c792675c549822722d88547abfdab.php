				...
				<form action="" method="post">
					<ul>
						...
						<li class="checkcode">
							...
							<img src="<?php echo U('code');?>" id="code"  onclick="this.src=this.src+'?_='+ new Date().getTime()"/>
...
//        var code = $(this).val();
//        $.ajax({
//            url:"<?php echo U('User/checkcode');?>",
//            data:{code:code},
//            type:'post',
//            success:function(msg){
//                console.log(this);
////                $('input[name=checkcode]').css('border',null);
//                if(msg.status==1){
//                    $('input[name=checkcode]').css('border','1px solid green');
//                }else{
//                    $('input[name=checkcode]').css('border','1px solid red');
//                }
//            }
//        });
//    });
