...
<body>
    ...
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <?php if(empty($_SESSION['user_id'])): ?><li>您好，欢迎来到京西！[<a href="<?php echo U('User/login');?>">登录</a>] [<a href="<?php echo U('User/regist');?>">免费注册</a>] [<a href="<?php echo U('User/registbyemail');?>">邮箱注册</a>]</li><?php else: ?>
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="/<?php echo ($pic["0"]["goods_img"]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="/<?php echo ($pic["0"]["goods_img"]); ?>" width="350" height="350" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
						...
						<ul>
                            <?php if(is_array($sigle)): $i = 0; $__LIST__ = $sigle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="product">
								<dl>
									...
									<dd>
                                        <?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a <?php if(($i) == "1"): ?>class="selected"<?php endif; ?> href="javascript:;"><?php echo ($v["attr_values"]); ?> <input type="radio" name="attr[<?php echo ($v["attr_id"]); ?>]" value="<?php echo ($v["id"]); ?>" <?php if(($i) == "1"): ?>checked="checked"<?php endif; ?> /></a><?php endforeach; endif; else: echo "" ;endif; ?>
					...
					<div class="comment detail_div mt10">
						<div class="comment_summary">
							...
							<div class="buyer fl">
								<dl>
									<dt>买家印象：</dt>
                                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd><span><?php echo ($vo["name"]); ?></span><em>(<?php echo ($vo["count"]); ?>)</em></dd><?php endforeach; endif; else: echo "" ;endif; ?>
								</dl>
							</div>
						</div>
                        ...
                        <div class="user_pic">
                            <dl>
                                ...
                                <dd><a href="/Public/Home/"><?php echo ($vo["user_name"]); ?></a></dd>
                            </dl>
                        </div>
                        <div class="item">
                            <div class="title">
                                ...
                                <form action="<?php echo U('comment');?>" method="post">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="checkbox" name="old[]" value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); endforeach; endif; else: echo "" ;endif; ?>
                                        </li>

                                        <li>
                                            <label for="">买家印象：</label>
                                            <input type="text" name="name">(多个印象使用英文逗号进行分割)
                                        </li>
