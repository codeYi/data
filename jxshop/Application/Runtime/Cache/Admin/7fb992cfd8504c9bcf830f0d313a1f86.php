...
<h1>
    ...
    <span class="action-span"><a href="<?php echo U('add');?>">添加用户名</a></span>
        ...
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center" ><span>
                    <?php if(($vo["attr_type"]) == "1"): ?>唯一属性<?php else: ?>单选属性<?php endif; ?>
                </span></td>
                <td align="center" ><span>
                    <?php if(($vo["attr_input_type"]) == "1"): ?>手工输入<?php else: ?>列表选择<?php endif; ?>
                </span></td>
                <td align="center" ><?php echo ($vo["attr_value"]); ?></td>

                <td align="center">
                <a href="<?php echo U('edit','attr_id='.$vo['id']);?>" title="编辑">编辑</a>
                <a href="<?php echo U('dels','attr_id='.$vo['id']);?>" onclick="return confirm('确定删除:<?php echo ($vo["attr_name"]); ?>');" title="回收站">删除</a>
                    </gt>
                </td>
