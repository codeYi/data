...
<div class="form-div">
    <form action="" name="searchForm">
        ...
        <select name="intro_type">
            ...
            <option value="is_rec"<?php if(($_GET['intro_type']) == "is_rec"): ?>selectd="selected"<?php endif; ?>>推荐</option>
            <option value="is_new" <?php if(($_GET['intro_type']) == "is_new"): ?>selectd="selected"<?php endif; ?>>新品</option>
            <option value="is_hot" <?php if(($_GET['intro_type']) == "is_hot"): ?>selectd="selected"<?php endif; ?>>热销</option>
        </select>
        <!-- 上架 -->
        <select name="is_sale">
            <option value='0'>全部</option>
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($data["data"])): $i = 0; $__LIST__ = $data["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><span onclick=""><?php echo ($goods_sn); ?></span></td>
                <td align="center"><span><?php echo ($goods_price); ?></span></td>
                ...
                <a href="<?php echo U('dels','goods_id='.$vo['id']);?>" onclick="return confirm('确定删除:<?php echo ($vo["goods_name"]); ?>');" title="回收站"><img src="/Public/Admin/Images/icon_trash.gif" width="16" height="16" border="0" /></a></td>
