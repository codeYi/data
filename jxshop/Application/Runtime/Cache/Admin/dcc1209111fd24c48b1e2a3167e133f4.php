       ...
       <div class="list-div">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="left"><?php echo ($info["order_price"]); ?></td>
                </tr>
                <tr>
                    ...
                    <td align="left"><?php if(($info["pay_status"]) == "1"): ?>已支付<?php endif; if(($info["order_status"]) == "2"): ?>已发货<?php else: ?>未发货<?php endif; ?></td>
                </tr>
                <tr>
                    <td align="right" width="18%">收货人:</td>
                    <td align="left" width="34%"><?php echo ($info["username"]); ?></td>
